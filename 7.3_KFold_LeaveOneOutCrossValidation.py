...
print("En iyi sonuç:",tree_grid_search_kf.best_params_)
print("En iyi acc:", tree_grid_search_kf.best_score_)

#LOO
loo = LeaveOneOut()
tree_grid_search_loo = GridSearchCV(tree, tree_param_dist, cv = loo)
tree_grid_search_loo.fit(X_train, y_train)
print("En iyi sonuç:",tree_grid_search_loo.best_params_)
print("En iyi acc:", tree_grid_search_loo.best_score_)
