...
feature_importances_sorted = sorted(zip(feature_importances_, feature_names), reverse =True )

for importance, feature_names in feature_importances_sorted:
