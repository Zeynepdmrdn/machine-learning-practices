...
#Ridge gereksiz parametrelerin katsayıları azaltılıyor
ridge = Ridge()
...
print("Ridge en iyi acc:", ridge_grid_search.best_score_)
...
#Lasso gereksiz parametreler 0 alınıyor
lasso = Lasso()
...
print("Lasso en iyi acc:", lasso_grid_search.best_score_)
